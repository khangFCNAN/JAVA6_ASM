...
public class indeWebController {
	...
	public String index(Model model) {
		ResponseEntity<SanPham[]> reponse = restTemplate.getForEntity("http://localhost:8080/api/sanpham", SanPham[].class);
		SanPham[] sanphams = reponse.getBody();
